...
namespace SMOSEC.Infrastructure
{
    ...
    public class SMOSECDbContext : DbContext, IDbContext
    {
        ...
        /// 申明所需要映射的所有类
        /// </summary>
        public DbSet<cmdb_machineroom> AssLocations { get; set; }
        public DbSet<cmdb_asset> Assetss { get; set; }
//        public DbSet<AssetsSN> AssetsSNs { get; set; }
        public DbSet<cmdb_assettype> AssetsTypes { get; set; }
        public DbSet<cmdb_brand> AssetsBrands { get; set; }
        public DbSet<cmdb_team> AssetsTeam { get; set; }
        public DbSet<cmdb_project> AssetsProject { get; set; }
        public DbSet<cmdb_payman> AssetPayman { get; set; }
        public DbSet<cmdb_role> AssetRole { get; set; }

        public DbSet<cmdb_repairlog> AssRepairOrders { get; set; }
        ...
        public DbSet<cmdb_uselog> AssBorrowOrders { get; set; }
        public DbSet<cmdb_assettouselog> AssBorrowOrderRows { get; set; }
        ...
        public DbSet<cmdb_userinfo> coreUsers { get; set; }
        public DbSet<cmdb_useman> Userman { get; set; }
        public DbSet<cmdb_modityhistory> AssModifyLog { get; set; }
