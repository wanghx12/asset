...
namespace SMOSEC.UI
{
    ...
    public class AutofacConfig
    {
        ...
        ///// 资产品牌型号相关服务接口
        ///// </summary>
        public IAssBrandService assBrandService;
        ///// <summary>
        ///// 报修单相关服务接口
        ///// </summary>
        ...
        public IAssPaymanService assPaymanService;
        public IAssProService assProService;
        public IAssTeamService assTeamService;
        public IAssRoleService assRoleService;
        public IAssUserService assUserService;
        /// <summary>
        /// 初始化
        /// </summary>
        public void Init()
        {
            ...
            containerBuilder.RegisterType<AssetsBrandRepository>().As<IAssetsBrandRepository>().InstancePerDependency();
            containerBuilder.RegisterType<AssetsPaymanRepository>().As<IAssetsPaymanRepository>().InstancePerDependency();
            containerBuilder.RegisterType<AssetsProRepository>().As<IAssetsProRepository>().InstancePerDependency();
            containerBuilder.RegisterType<AssetsTeamRepository>().As<IAssetsTeamRepository>().InstancePerDependency();
            containerBuilder.RegisterType<AssetsRoleRepository>().As<IAssetsRoleRepository>().InstancePerDependency();
            containerBuilder.RegisterType<AssetsUserRepository>().As<IAssetsUserRepository>().InstancePerDependency();
            ...
            containerBuilder.RegisterType<AssBrandService>().As<IAssBrandService>().InstancePerLifetimeScope();
            ...
            containerBuilder.RegisterType<AssPaymanService>().As<IAssPaymanService>().InstancePerLifetimeScope();
            containerBuilder.RegisterType<AssProService>().As<IAssProService>().InstancePerLifetimeScope();
            containerBuilder.RegisterType<AssTeamService>().As<IAssTeamService>().InstancePerLifetimeScope();
            containerBuilder.RegisterType<AssRoleService>().As<IAssRoleService>().InstancePerLifetimeScope();
            containerBuilder.RegisterType<AssUserService>().As<IAssUserService>().InstancePerLifetimeScope();
        ...
        public AutofacConfig()
        {
            ...
            this.assBrandService = container.Resolve<IAssBrandService>();
            ...
            this.assPaymanService = container.Resolve<IAssPaymanService>();
            this.assProService = container.Resolve<IAssProService>();
            this.assTeamService = container.Resolve<IAssTeamService>();
            this.assRoleService = container.Resolve<IAssRoleService>();
            this.assUserService = container.Resolve<IAssUserService>();
